                ...
                <div class="col-full">
                    ...
                    @if($i==0) 
                        <div class="featured__column featured__column--big">
                            <div class="entry" style="background-image:url('images/{{ $post->image }}');">
                                
                                <div class="entry__content">
                                    <span class="entry__category"><a href="?cat={{ $post->cat->id }}">{{ $post->cat->name }}</a></span>

                                    <h1><a href="showpost?slug={{ $post->slug }}" title="{{ $post->title }}">{{ $post->title }}</a></h1>
            ...
            <nav class="pgn">
                ...
                <ul>
                    <li><span class="pgn__num current">{{ $cat->name }} 
                        <a href="/" style="text-decoration: none !important; color: inherit;"><i class="fa fa-times-circle fa-lg"></i></a></span></li>
                </ul>
            </nav>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        ...
                        <div class="audio-wrap">
                            <audio id="player" src="audio/{{ $post->audio }}" width="100%" height="42" controls="controls"></audio>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <div class="entry__date">
                                <a href="showpost?slug={{ $post->slug }}"><?php echo date("F j, Y ", strtotime($post["created_at"])) . " "; ?></a>
                            </div>
                            <h1 class="entry__title"><a href="showpost?slug={{ $post->slug }}">{{ $post->title }}</a></h1>
            ...
            <div class="col-full">
                <nav class="pgn">
                    <ul>
                        ...
                        <li><a href="#0" class="pgn__num">2</a></li>
